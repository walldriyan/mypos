// src/components/credit/PaymentsList.tsx
"use client";
...
import { deletePaymentAction } from "@/lib/actions/credit.actions";
...
export function PaymentsList({ payments, onPaymentDeleted }: PaymentsListProps) {
         ...
         <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        This will permanently delete this payment record and update the GRN's balance. This action cannot be undone.
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
